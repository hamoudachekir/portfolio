        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, idx) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-r ${card.gradient} rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500`}></div>
              ...
              <div className="relative h-full p-8 bg-[#1a1a3e]/50 backdrop-blur-sm border border-white/10 rounded-2xl hover:border-purple-500/50 transition-all duration-300">
                {/* Icon */}
                <div className={`inline-flex p-4 bg-gradient-to-r ${card.gradient} rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
