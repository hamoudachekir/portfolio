...
/**
 * React Bits — Aurora (JS + Tailwind variant)
 * Source: https://reactbits.dev (@react-bits/Aurora-TS-TW / Aurora-JS-TW)
 * Colors tuned for Hamouda: Mediterranean night + AI signal (cyan / mint / amber).
 */
